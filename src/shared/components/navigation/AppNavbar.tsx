...
function AppNavbar() {
  return (
    <nav className="xs:right-7 xs:w-82 bg-navbar font-titillium-web fixed top-7 right-0 z-50 mx-3.5 h-11 w-60 rounded-2xl border-none text-white shadow-lg backdrop-blur-md xl:right-1/2 xl:h-13.5 xl:w-200 xl:translate-x-1/2">
